...
class OntKycLog(Base):
    ...
    ont_kyc_data = Column(String(4096))
    ont_OntPassOntId = Column(String(1024))
    ont_UserOntId = Column(String(1024))
    ont_Signature = Column(String(1024))
    ont_Claims = Column(String(4096))
    ...
    def __init__(self, ont_kyc_data=None, ont_OntPassOntId=None, ont_UserOntId=None, ont_Signature=None, ont_Claims=None,
                    ont_Claims_clm_IssuerName=None, ont_Claims_clm_Email=None, ont_Claims_clm_Country=None, ont_Claims_clm_PhoneNumber=None,
                    ont_Claims_clm_DocumentType=None, ont_Claims_clm_Name=None,
    ...
    @classmethod
    def insert(cls, ont_kyc_data=None, ont_OntPassOntId=None, ont_UserOntId=None, ont_Signature=None, ont_Claims=None,
        ...
        newOKL = OntKycLog(
            ont_kyc_data=ont_kyc_data, ont_OntPassOntId=ont_OntPassOntId, ont_UserOntId=ont_UserOntId,
