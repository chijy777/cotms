...
//            System.out.println(Helper.toHexString(ontSdk.getConnect().getBlock(1).transactions[0].sigs[0].sigData[0]));
            ...
            System.out.println(ontSdk.getConnect().getGenerateBlockTime()); //chijy
...
//chijy        wm.setRpc(rpcUrl);
//chijy        wm.setRestful(restUrl);
        wm.setDefaultConnect(wm.getRestful());

//chijy        wm.openWalletFile("./Demo3.json");
